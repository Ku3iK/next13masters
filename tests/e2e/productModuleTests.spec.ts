...
test.describe("Product Module Tests", () => {
	...
	test(`2. products list API implemented`, async ({ page }) => {
		await page.goto("/products");
	...
	test(`3. single product page implemented`, async ({ page }) => {
	...
	test(`4. single product SEO`, async ({ page }) => {
		await openRandomProductPage({ page });
