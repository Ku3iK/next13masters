...
test.describe("Product Interaction Tests", () => {
	...
	test(`4. increment and decrement on cart`, async ({ page, context }) => {
		await context.clearCookies();
	...
	test(`5. sort by prices`, async ({ page }) => {
		await page.goto(`/products`);
	...
	test(`6. sort by rating`, async ({ page }) => {
		await page.goto(`/products`);
